...
export default function Step1Details({ data, errors, onChange }: Props) {
  return (
    <div className="space-y-5">
      ...
      <div>
        <label className="block text-sm font-medium text-text-primary mb-1" htmlFor="hostNames">
      ...
      <div>
        <label className="block text-sm font-medium text-text-primary mb-1" htmlFor="contactNumber">
