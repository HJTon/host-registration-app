  ...
  return (
    <div className="space-y-2">
      {options.map(({ value, label }) => (
        <label
          key={value}
          className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-surface transition-colors min-h-[48px]"
        >
          <input
            type="checkbox"
    ...
    <div className="space-y-6">
      <div>
        <p className="text-sm font-medium text-text-primary mb-2">
          Facilities available <span className="text-text-secondary font-normal">(tick all that apply)</span>
        </p>
        <CheckboxList
      ...
      <div>
        <p className="text-sm font-medium text-text-primary mb-2">
          Access limitations <span className="text-text-secondary font-normal">(tick all that apply)</span>
        </p>
        <CheckboxList
      ...
      {/* Parking & bikes */}
      <div>
        <label className="block text-sm font-medium text-text-primary mb-1" htmlFor="parkingInfo">
